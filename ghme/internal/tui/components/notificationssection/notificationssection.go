...
// SetTagFilter is a no-op: local tags apply to PRs and issues, not notifications.
func (m *Model) SetTagFilter(string) {}

// RefreshRows is a no-op for the notifications section.
