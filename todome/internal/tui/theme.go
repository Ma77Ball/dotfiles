...
// Palette and styles ported from msgme (which ports gh-dash) so todome shares the
// family look: a two-line cyan logo + pill tab row with a thick underline,
// two-line table rows with a full-width selection bar, a left-bordered notes
// sidebar, and a full-width footer bar with a "? help" pill. Colors are adaptive
// light/dark pairs (ANSI 256).
var (
